...
<div id="wrapper">
	...
	<section>
	<h1>Pretraga postova: </h1>
		<div class="content">
			<form action="" method="get">
			<div id="search1">
				<label for="authors">Izaberite autora: </label>
			...
			<div>
				<label for="title">Unesite naslov, ili deo naslova: </label>
		...
		<p><a href="?dodaj">Dodajte novi tekst</a></p>
